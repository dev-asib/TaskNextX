...
class AlertHelper {
  static void showFlushBarMessage({
    ...
    BuildContext? context = TaskNextX.navigatorKey.currentContext;
    ...
    if (context != null) {
      ...
      Flushbar(
        ...
        backgroundColor: isError == true
            ? (isBrightness
                ? LightShadeAppColors.anotherFlushErrorBackgroundColor
                : DarkShadeAppColors.anotherFlushErrorBackgroundColor)
            : (isBrightness
