...
class CompletedTaskViewViewModel {
  static Future<NetworkResponse> completedTask() async {
    final NetworkResponse response = await Get.find<NetworkServices>().getRequest(
      ApiUrls.completedTasks,
    );
    return response;
  }
}
